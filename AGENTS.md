...
Never edit files in the `.adonisjs` folder manually unless explicitly instructed. The folder is generated by `bun run dev`; keep generated changes when that command updates it.
